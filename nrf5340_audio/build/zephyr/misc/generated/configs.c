...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_BUF_USER_DATA_SIZE, 192);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_AUDIO, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_AUDIO_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_AUDIO_LOG_LEVEL, 3);
